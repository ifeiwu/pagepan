        ...
        <form class="uk-form-stacked" id="loginForm">
            ...
            <fieldset class="uk-fieldset">
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <input class="uk-input" name="password" type="password" value="" required>
                    </div>
                </div>
                ...
                <div class="uk-margin uk-text-center">
                    <a href="admin/forget" class="uk-text-muted" style="font-size:13px">忘记密码？</a>
                </div>
            </fieldset>
        </form>
    </div>
