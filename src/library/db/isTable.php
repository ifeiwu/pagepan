...
return function ($name)
{
    ...
    if ( $this->dbtype == 'mysql' ) {debug("SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA='" . $this->dbname . "' AND TABLE_NAME ='" . $this->getTableName($name, false) . "'");
