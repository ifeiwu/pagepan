                        ...
                        events.push({
                            init: function () {
                                ...
                                setTimeout(() => {
                                    ...
                                    this.navigation.$prevEl.addClass('animated');
                                    this.navigation.$nextEl.addClass('animated');

                                    if ( ! this.isEnd )
                                    {
                                        this.navigation.$nextEl.addClass('fadeInRight');
                                    }
                            ...
                            slideChange: function () {
                                ...
                                if ( ! this.isBeginning ) {
                                    this.navigation.$prevEl.removeClass('fadeOutLeft').addClass('fadeInLeft');
                                } else {
                                    this.navigation.$prevEl.removeClass('fadeInLeft').addClass('fadeOutLeft');
                                }

                                if ( ! this.isEnd ) {
                                    this.navigation.$nextEl.removeClass('fadeOutRight').addClass('fadeInRight');
                                } else {
                                    this.navigation.$nextEl.removeClass('fadeInRight').addClass('fadeOutRight');
                                }
                            }
                        });
                    }
