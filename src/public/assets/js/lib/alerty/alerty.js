...
(function () {
  ...
  var Alerty = function() {
    ...
    var Dialog = {
      ...
      previousCallback: null,  // for cache previous toast callbak, to handle if call more than 1 alerty
      ...
      setup: function(type, content, opts, onOk, onCancel) {
        ...
        if (type === 'toast') {
          ...
          if (type === 'confirm' || type === 'prompt') {
            ...
            commonUse.removeElement($btnCancel); // toast and alery type do not need cancel btn
          }
        }
      ...
      bindEvent: function($modal, onOk, onCancel) {
        ...
        // toast delay hide
        if (commonUse.hasClass($modal, 'toast')) {
          setTimeout(function() {
            // if toast has been removed
    ...
    return {
      // return alerty.toast();
      toast: function(content, opts, callback) {
        Dialog.setup('toast', content, opts, callback);
      },
