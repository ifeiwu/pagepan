/**
 * 视频播放组件
 * <video class="video-js" data-theme="<?=$setting['userdata.video.theme']; ?>" data-poster="<?=helper('item/image', [$path, $image]); ?>" width="100%" controls>
 *     <source src="<?=helper('item/video', [$path, $item['video']]); ?>"></source>
 * </video>
 **/
define(function (require) {
    ...
    require(['video', 'text!lib/video/lang/zh-CN.json'], function (videojs, lang) {
        ...
        $('video.video-js').each(function (i, el) {
            ...
            const player = new videojs(el, {poster: poster, controls: true, preload: 'none', width: '100%', language: 'zh-CN', fluid: true}, function () {
