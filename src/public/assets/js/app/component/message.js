define(function (require) {
    ...
    const contact = function (component_selector) {
        ...
        require(['tippy', 'i18n', 'parsley/i18n/' + language], function (tippy, i18n) {
            ...
            i18n.set('zh-cn', { success_text: '发送成功！', wait_text: '请稍候.', fail_text: '发送失败！', retry_text: '重试'});
            i18n.set('zh-tw', { success_text: '發送成功！', wait_text: '請稍候.', fail_text: '發送失敗！', retry_text: '重試'});
            i18n.set('en', { success_text: 'Sent successfully!', wait_text: 'Please wait.', fail_text: 'Failed to send!', retry_text: 'Retry'});
            ...
            tippy($form[0].querySelectorAll('input[required],textarea[required]'), {placement: 'top-start', hideOnClick: false, trigger: 'manual', theme: 'tomato'});
